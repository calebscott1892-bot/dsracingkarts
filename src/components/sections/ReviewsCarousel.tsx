...
import { Facebook, Star, ChevronLeft, ChevronRight, ExternalLink } from "lucide-react";
...
const FACEBOOK_REVIEW_URL = "https://www.facebook.com/dsracingkarts/reviews";
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            >
              ...
              <span
                className="text-xs uppercase tracking-[0.2em] text-white/40 transition-colors duration-300 group-hover/f:text-white/80"
                style={{ fontFamily: "var(--font-heading), system-ui, sans-serif" }}
              >
                Facebook Reviews
              </span>
              <ExternalLink size={11} className="text-white/20 group-hover/f:text-white/50 transition-colors duration-300" />
            </a>
          </div>
        </div>
      </div>
